        ...
        for (int rowNum = sheet.getFirstRowNum(); rowNum <= lastRowNum; rowNum++) {
            ...
            for (int colNum = 0; colNum < lastColNum; colNum++) {
                ...
                if (cell == null) {    //特殊情况 空白的单元格会返回null
                    sb.append("<td style='border-top:solid #d0d7e5 1px;border-right:solid #d0d7e5 1px;border-left:solid #d0d7e5 1px;border-bottom:solid #d0d7e5 1px;'>&nbsp;</td>");
                    continue;
                }
